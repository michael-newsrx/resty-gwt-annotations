...
- Added utility method for returning new mutated result objects for use in map and recover methods. (Michael Conrad)
...
- Initial release of `RESTy-GWT Annotations` module. (Michael Conrad)
